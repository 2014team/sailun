...
public class BannerController {
	 ...
	 * @return
	 */
	@AdminControllerLog(description="广告 banner保存")
	@ResponseBody
	@RequestMapping(value = "/admin/center/banner/save", method = { RequestMethod.GET, RequestMethod.POST })
	public JsonResult save(BannerVo bannerVo) {
		JsonResult result = new JsonResult();

		// 参数验证
		String errMsg = bannerService.checkParam(bannerVo);
	 ...
	 * @return
	 */
	@AdminControllerLog(description="广告 banner删除")
	@ResponseBody
	 ...
	 * @return
	 */
	@AdminControllerLog(description="广告 banner批量删除")
	@ResponseBody
