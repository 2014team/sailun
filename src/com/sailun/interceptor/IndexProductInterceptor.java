 ...
 */
public class IndexProductInterceptor implements HandlerInterceptor {
	
	
	@Autowired
	private CreateFileSerivce createFileSerivce;
	
	private static org.slf4j.Logger logger = LoggerFactory.getLogger(IndexProductInterceptor.class);
