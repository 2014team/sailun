						...
						<div class="times2-item flex-item">
							...
							<div class="flex-item banner-anime">
								<a href="https://valino.jp/info/works/">
									<div class="image-wrap">
										<div class="image-times" style="background-image:url(/web/img/times_01.jpg);"></div>
									</div>
									<div class="text">
...
-->
					...
					<div class="flex-item banner-anime">
						<a href="https://valino.jp/tosy2020/">
							<div class="image-wrap">
								<div class="image-times" style="background-image:url(/web/img/times_08.jpg);"></div>
							</div>
							<div class="text">
								<h4>とっしーくん間違い探し</h4>
							</div>
					...
					-->
						...
						<!--
					<div class="flex-item banner-anime">
						<a href="https://valino.jp//web/images/ct_n820.pdf">
							<div class="image-wrap">
								<div class="image-times" style="background-image:url(/web/img/times_14.jpg);"></div>
							</div>
							<div class="text">
