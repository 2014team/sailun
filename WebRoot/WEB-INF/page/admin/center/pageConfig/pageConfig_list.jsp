...
<html>
  <head>
  	...
  	<script type="text/javascript" src="/admin/js/pageConfig_list.js?t=<%=new java.util.Date().getTime() %>"></script>
  </head>
   ...
   <body>
    <div class="x-nav">
      <span class="layui-breadcrumb">
        <a href="">首页</a>
        <a href="/admin/user/list/ui">页面配置管理</a>
        <a>
          <cite>列表</cite></a>
      </span>
    ...
    <div class="x-body">
      <div class="layui-row">
        <div class="layui-form layui-col-md12 x-so">
        	<r:auth menuName="页面配置/查询" menuUrl="页面配置/查询"> 	
	         
				 	配置页面：
		          <div class="layui-inline">
				    <input class="layui-input" name="configPageName" id="configPageName" autocomplete="off">
				  </div>
				 	编号：
		          <div class="layui-inline">
    ...
    <script type="text/html" id="toolbar">
      <div class="layui-btn-container toolbar">
		<r:auth menuName="页面配置/批量删除" menuUrl="页面配置/批量删除">
         <button class="layui-btn layui-btn-sm layui-btn-danger" onclick="batchDel()" >批量删除</button>
    		</r:auth>
         <r:auth menuName="页面配置/增加" menuUrl="页面配置/增加">
    ...
    <script type="text/html" id="operateBarTpl">
		<div class="td-manage">
			<r:auth menuName="页面配置/编辑" menuUrl="页面配置/编辑">
              <a title="编辑"  lay-event="edit" href="javascript:;">
                <i class="layui-icon" style="font-size: 20px;">&#xe642;</i>
              </a>
     		</r:auth>
			<r:auth menuName="页面配置/删除" menuUrl="页面配置/删除">
