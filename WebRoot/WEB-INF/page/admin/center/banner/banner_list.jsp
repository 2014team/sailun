   ...
   <body>
    <div class="x-nav">
      <span class="layui-breadcrumb">
        <a href="">首页</a>
        <a href="/admin/user/list/ui">广告 banner管理</a>
        <a>
          <cite>列表</cite></a>
      </span>
    ...
    <div class="x-body">
      <div class="layui-row">
        <div class="layui-form layui-col-md12 x-so">
        	<r:auth menuName="广告 banner列表/查询" menuUrl="广告 banner列表/查询"> 	
    ...
    <script type="text/html" id="toolbar">
      <div class="layui-btn-container toolbar">
		<r:auth menuName="广告 banner列表/批量删除" menuUrl="广告 banner列表/批量删除">
         <button class="layui-btn layui-btn-sm layui-btn-danger" onclick="batchDel()" >批量删除</button>
    		</r:auth>
         <r:auth menuName="广告 banner列表/增加" menuUrl="广告 banner列表/增加">
    ...
    <script type="text/html" id="operateBarTpl">
		<div class="td-manage">
			<r:auth menuName="广告 banner列表/状态修改" menuUrl="广告 banner列表/状态修改">
