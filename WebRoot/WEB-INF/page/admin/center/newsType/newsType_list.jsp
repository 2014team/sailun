   ...
   <body>
    ...
    <div class="x-body">
      <div class="layui-row">
        <div class="layui-form layui-col-md12 x-so">
        	<r:auth menuName="新闻类别/查询" menuUrl="新闻类别/查询"> 	
    ...
    <script type="text/html" id="toolbar">
      <div class="layui-btn-container toolbar">
		<r:auth menuName="新闻类别/批量删除" menuUrl="新闻类别/批量删除">
         <button class="layui-btn layui-btn-sm layui-btn-danger" onclick="batchDel()" >批量删除</button>
    		</r:auth>
         <r:auth menuName="新闻类别/增加" menuUrl="新闻类别/增加">
    ...
    <script type="text/html" id="operateBarTpl">
		<div class="td-manage">
			...
			<r:auth menuName="新闻类别/删除" menuUrl="新闻类别/删除">
