/*更新*/
const UPDATE = getAminUrl('admin/CENTER/PAGECONFIG/UPDATE');
/*保存*/
const SAVE = getAminUrl('admin/CENTER/PAGECONFIG/SAVE');
/*唯一性验证*/
const CHECKUNIQUE = getAminUrl('admin/CENTER/PAGECONFIG/CHECKUNIQUE');
