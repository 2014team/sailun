/*列表数据*/
const LIST = getAminUrl('admin/CENTER/DRIVER/LIST')
/*列表删除*/
const DELETE = getAminUrl('admin/CENTER/DRIVER/DELETE');
/*编辑*/
const EDIT = getAminUrl('admin/CENTER/DRIVER/EDIT');
/*批量删除*/
const BATCH_DELETE = getAminUrl('admin/CENTER/DRIVER/BATCH/DELETE');
/*查找单个对象*/
const GET = getAminUrl('admin/CENTER/DRIVER/GET');
//行对象
var rowObj = "";
...
/*删除*/
function del(obj) {
	var driverId = obj.data.driverId;
...
function batchDel() {
	...
	layer.confirm('确认要删除吗？', function(index) {
		...
		$.each(selectData,function(i,e){
			array.push(e.driverId);
		 })
		reqPostHasParameter(BATCH_DELETE, {"driverIdArr":array},function(result) {
...
function updateRowData(obj){
	var reqData = obj.field;
	 reqPostHasParameter(GET, {"driverId":reqData.driverId}, function(result) {
