/*更新*/
const UPDATE = getAminUrl('admin/CENTER/PAGECREATE/UPDATE');
/*保存*/
const SAVE = getAminUrl('admin/CENTER/PAGECREATE/SAVE');
...
//检查是否保存还是修改操作
function checkSave() {
	var userId = $("#pageCreateId").val();
	return userId;
};

//回显Select选值
function echoSelect(){
	echoSelectData("pageConfigId",$("#pageConfigId").attr('value'));
}