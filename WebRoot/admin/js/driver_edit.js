/*更新*/
const UPDATE = getAminUrl('admin/CENTER/DRIVER/UPDATE');
/*保存*/
const SAVE = getAminUrl('admin/CENTER/DRIVER/SAVE');
...
layui.use([ 'form', 'layer' ,'upload','layedit'], function() {
	...
	//保存
	 form.on('submit(editSave)', function(obj) {
		...
		formData.append("driverId", reqData.driverId);
		formData.append("driverName", reqData.driverName);
